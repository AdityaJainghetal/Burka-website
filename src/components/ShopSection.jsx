...
//     if (course.sizes && course.sizes.length > 1) {
//       // If multiple sizes available, navigate to product details
//       navigate(`/product-details/${course._id}`);
//     } else {
//       // If single size or no size specified, add directly to cart
//       dispatch(
//         addtoCart({
//           id: course._id,
//           name: course.name,
