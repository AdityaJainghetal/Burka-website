...
//           `https://backend-1-cafd.onrender.com/product/category/${main.category._id}`
//         );
//         const subCategoryRes = await axios.get(
//           `https://backend-1-cafd.onrender.com/product/subcategory/${main.category._id}`
//         );
...
//         // Now fetch all courses with the same category ID
//         const sameCategoryRes = await axios.get(
//             `https://backend-1-cafd.onrender.com/product/category/${main.category}`
//         );
